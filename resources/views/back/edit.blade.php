                    ...
                    <div class="card-body">
                        <form action="{{route('program.update', $program->id)}}" method="post"
                            ...
                            <div class="form-group">
                                ...
                                <input name="title" type="text" class="form-control" value="{{$program->title}}">
                            </div>

                            <div class="form-group">
                                <label for="exampleInputFile">Ubah Gambar</label>
                                <div class="custom-file">
                                    <input name="photo" value="{{$program->photo}}" type="file"
                                        class="custom-file-input" id="customFile">
                                    <label class="custom-file-label" for="customFile">{{$program->photo}}</label>
                                </div>
                            </div>

                            <div class="image">
                                <label>Foto yang dipakai</label> <br>
                            ...
                            <div class="form-group">
                                ...
                                <input name="donation_target" type="text"
                                    ...
                                    value="{{$program->donation_target}} {{ old('donation_target') }}">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input name="shelter_account_number" type="text" class="form-control"
                                    value="{{$program->shelter_account_number}}">
                            </div>

                            <div class="form-group">
                                <label>Deskripsi Program</label>
                                <textarea name="description" style="height: 300px;"
                                    class="form-control my-editor">{{$program->description}}</textarea>
                            </div>
