...
INSERT INTO `donation_confirmations` (`id`, `program_id`, `users_id`, `id_transaksi`, `nama_donatur`, `email`, `nominal_donasi`, `dukungan`, `bukti_pembayaran`, `bukti_tf`, `created_at`, `updated_at`) VALUES
